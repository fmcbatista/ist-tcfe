...
\includegraphics[width=0.4\linewidth]{naturalsolution.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.65\linewidth]{ampresponse.eps}
...
\begin{figure}[h] \centering
\includegraphics[width=0.65\linewidth]{phaseresponse.eps}
