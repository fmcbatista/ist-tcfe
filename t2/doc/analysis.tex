...
After this, in step (2), we determined the equivalent resistance as seen from the capacitor terminals. In order to do so, we followed the professor's sugestion: In this section of the analysis, the voltage difference Vx is computed and will be used as a boundary condition so as to allow us to solve the following...(!nao percebi muito bem, por favor acabem!)... 
