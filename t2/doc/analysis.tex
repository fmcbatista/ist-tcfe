...
In this section, the circuit shown in Figure~\ref{fig:T1Circuit} is analysed theoretically, in terms of its nodes' voltages and meshes' equations.
In order to do so, we first had to number and identify all the nodes of the given circuit. In Figure~\ref{fig:T1Nodes} we can see the distribution of such nodes.

\begin{figure}[h] \centering
\includegraphics[width=0.4\linewidth]{T1Nodes.pdf}
